...
BaseHTTPContentProcess::BaseHTTPContentProcess(std::string _filePath, std::string _contentType)
        : filePath(std::move(_filePath)), contentType(std::move(_contentType)) {}

HTTPParser BaseHTTPContentProcess::Process(HTTPParser &request) {
